...
[System.Serializable]
		...
		private void Raycast()
		{
			...
			if(Physics.Raycast(ray, out hit, raycastDistance, layerMask))
			{
				...
				{ //get hideable object
					...
					hideable = hit.collider.GetComponent<Hideable>();
					//if(hideable.isInRange)
					
						canHide = true;
						hideText.enabled = true;
						GetHideConstraint(hideable);
				...
				//if so, get the locator of the object for the hide cam
			}
			else{
			canHide = false;
			hideText.enabled = false;
		...
		public void GetHideConstraint(Hideable hideable)
		{
			hideTarget = hideable.transform.Find("HideConstraint");
		}
